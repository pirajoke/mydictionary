...
| `mirror-v10.txt` | Lexi Companion v10 (active) | `OpenAIResponsesProvider.generate_mirror` | `tests/fixtures/mirror_quality_v2.json`, `tests/test_zerkalo_communication_v1.py` |

`ai-tutor-v1.txt` and `mirror-v9.txt` are retained as the historical
predecessors to the active Lexi contracts. Earlier Mirror contracts, including
`mirror-v8.txt`, remain historical evidence of the reviewed behavior.
