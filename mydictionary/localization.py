...
_LEARNING_BLOCK_COPY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "block_reinforce_quiz": "🧠 Reinforce with a quiz",
        "block_reinforce_written": "✍️ Answer in writing",
        "block_ai_tutor": "AI tutor",
        "block_voice_practice": "🎤 Pronounce 10 words",
        "block_topics_study": "Topics 📚",
        "block_cards_study": "📖 Back to cards",
    ...
    "fr": {
        ...
        "block_reinforce_quiz": "🧠 Consolider avec un quiz",
        "block_reinforce_written": "✍️ Répondre par écrit",
        "block_ai_tutor": "Tuteur IA",
        "block_voice_practice": "🎤 Prononcer 10 mots",
        "block_topics_study": "Thèmes 📚",
        "block_cards_study": "📖 Revoir les cartes",
    ...
    "de": {
        ...
        "block_reinforce_quiz": "🧠 Mit einem Quiz festigen",
        "block_reinforce_written": "✍️ Schriftlich antworten",
        "block_ai_tutor": "KI-Tutor",
        "block_voice_practice": "🎤 10 Wörter aussprechen",
        "block_topics_study": "Themen 📚",
        "block_cards_study": "📖 Zurück zu den Karten",
    ...
    "ja": {
        ...
        "block_reinforce_quiz": "🧠 クイズで定着",
        "block_reinforce_written": "✍️ 入力して答える",
        "block_ai_tutor": "AIチューター",
        "block_voice_practice": "🎤 10語を発音",
        "block_topics_study": "トピック 📚",
        "block_cards_study": "📖 カード一覧へ",
    ...
    "ar": {
        ...
        "block_reinforce_quiz": "🧠 ثبّت التعلم باختبار",
        "block_reinforce_written": "✍️ أجب كتابةً",
        "block_ai_tutor": "معلّم AI",
        "block_voice_practice": "🎤 انطق 10 كلمات",
        "block_topics_study": "الموضوعات 📚",
        "block_cards_study": "📖 العودة إلى البطاقات",
    ...
    "zh": {
        ...
        "block_reinforce_quiz": "🧠 用测验巩固",
        "block_reinforce_written": "✍️ 书面作答",
        "block_ai_tutor": "AI 导师",
        "block_voice_practice": "🎤 朗读 10 个单词",
        "block_topics_study": "主题 📚",
        "block_cards_study": "📖 返回卡片",
    ...
    "ru": {
        ...
        "block_reinforce_quiz": "🧠 Закрепить тестом",
        "block_reinforce_written": "✍️ Ответить письменно",
        "block_ai_tutor": "AI-репетитор",
        "block_voice_practice": "🎤 Произнести 10 слов",
        "block_topics_study": "Темы 📚",
        "block_cards_study": "📖 Вернуться к карточкам",
    ...
    "es": {
        ...
        "block_reinforce_quiz": "🧠 Reforzar con un test",
        "block_reinforce_written": "✍️ Responder por escrito",
        "block_ai_tutor": "Tutor de IA",
        "block_voice_practice": "🎤 Pronunciar 10 palabras",
        "block_topics_study": "Temas 📚",
        "block_cards_study": "📖 Volver a las tarjetas",
...
_USER_SURFACE_COPY = {
    "en": {
        ...
        "quick_start_again": "Start again",
        "quick_practice_mode": "Practice mode",
        "quick_choose_words": "Choose words",
        "practice_mode_prompt": "How do you want to practice these {count} words?",
        "practice_mode_cards": "Cards",
    ...
    "fr": {
        ...
        "quick_continue": "Continuer",
        "quick_start_again": "Recommencer",
        "quick_practice_mode": "Mode d’exercice",
        "quick_choose_words": "Choisir les mots",
        "practice_mode_prompt": "Comment voulez-vous travailler ces {count} mots ?",
        "practice_mode_cards": "Cartes",
    ...
    "de": {
        ...
        "command_ai": "KI-Tutor",
        "quick_continue": "Weiterlernen",
        "quick_start_again": "Neu starten",
        "quick_practice_mode": "Übungsmodus",
        "quick_choose_words": "Wörter auswählen",
        "practice_mode_prompt": "Wie möchtest du diese {count} Wörter üben?",
        "practice_mode_cards": "Karten",
    ...
    "ja": {
        ...
        "command_ai": "AIチューター",
        "quick_continue": "続ける",
        "quick_start_again": "最初から",
        "quick_practice_mode": "練習モード",
        "quick_choose_words": "単語を選ぶ",
        "practice_mode_prompt": "この{count}語をどう練習しますか？",
        "practice_mode_cards": "カード",
    ...
    "ar": {
        ...
        "command_stats": "تقدمي",
        "command_ai": "مدرّس AI",
        "quick_continue": "متابعة",
        "quick_start_again": "البدء من جديد",
        "quick_practice_mode": "وضع التدريب",
        "quick_choose_words": "اختيار الكلمات",
        "practice_mode_prompt": "كيف تريد التدرّب على هذه الكلمات وعددها {count}؟",
        "practice_mode_cards": "بطاقات",
    ...
    "zh": {
        ...
        "command_ai": "AI 导师",
        "quick_continue": "继续学习",
        "quick_start_again": "重新开始",
        "quick_practice_mode": "练习模式",
        "quick_choose_words": "选择单词",
        "practice_mode_prompt": "你想怎样练习这组 {count} 个单词？",
        "practice_mode_cards": "卡片",
    ...
    "ru": {
        ...
        "quick_continue": "Продолжить",
        "quick_start_again": "Начать заново",
        "quick_practice_mode": "Режим практики",
        "quick_choose_words": "Выбрать слова",
        "practice_mode_prompt": "Как будем тренировать эти {count} слов?",
        "practice_mode_cards": "Карточки",
    ...
    "es": {
        ...
        "quick_continue": "Continuar",
        "quick_start_again": "Empezar de nuevo",
        "quick_practice_mode": "Modo de práctica",
        "quick_choose_words": "Elegir palabras",
        "practice_mode_prompt": "¿Cómo quieres practicar estas {count} palabras?",
        "practice_mode_cards": "Tarjetas",
...
_CUSTOM_VOCABULARY_COPY = {
    "en": {
        "custom_vocab_prompt": "🦊 Add words for {language}\n\nSend one of these:\n• pasted lines: word — translation\n• a photo with words\n• a PDF\n• a voice note\n\nA complete pasted list is free. Missing translations, photos and PDFs use 1 AI credit; voice can use 2 credits. I will show a preview before saving.",
        "custom_vocab_preview_title": "✨ I prepared {count} words",
        "custom_vocab_preview_more": "…and {count} more",
        "custom_vocab_preview_confirm": "Check the list. Save only if it looks right.",
        "custom_vocab_save": "Save {count} words",
        "custom_vocab_cancel": "Cancel",
        "custom_vocab_stale": "This import has expired. Open Add my words again.",
        "custom_vocab_media_invalid": "I could not read this input. Use a clear JPG/PNG photo, a PDF up to 8 MB, or a shorter list.",
        "custom_vocab_ai_needed": "Add translations to the pasted list, or enable AI to fill them in.",
        "custom_vocab_voice_unavailable": "Voice import is unavailable or this note is outside the allowed limits.",
        "custom_vocab_invalid_text": "I could not find words. Put one word or phrase on each line; translation is optional.",
        "custom_vocab_failed": "I could not prepare the words. Nothing was saved and a failed AI request is not charged.",
        "custom_vocab_cancelled": "Import cancelled",
        "custom_vocab_language_changed": "The active language changed. Start this import again so words do not enter the wrong dictionary.",
        "custom_vocab_saved_short": "Saved",
        "custom_vocab_saved": "✅ Your dictionary is ready. Added: {inserted}; updated: {updated}; total for this pair: {total}.",
        "custom_vocab_practice": "Practice my words",
        "custom_vocab_card_front": "My words · {position}/{total}\n\n{target}{transcription}",
        "custom_vocab_reveal": "Show translation",
        "custom_vocab_stop": "Stop",
        "custom_vocab_none": "You have no custom words for the active language yet.",
        "custom_vocab_add": "Add my words",
        "custom_vocab_card_back": "My words · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_dont_know": "I don't know yet",
        "custom_vocab_know": "I know",
        "custom_vocab_practice_done": "🎉 Done! Your custom-word session is complete.",
    },
    "ru": {
        "custom_vocab_prompt": "🦊 Пополним твой словарь: {language}\n\nОтправь что-то одно:\n• список: слово — перевод\n• фото со словами\n• PDF\n• голосовое\n\nГотовый список с переводами бесплатный. Автоперевод, фото и PDF стоят 1 AI-кредит; голос может стоить 2. Перед сохранением я покажу результат.",
        "custom_vocab_preview_title": "✨ Я подготовил слова: {count}",
        "custom_vocab_preview_more": "…и ещё {count}",
        "custom_vocab_preview_confirm": "Проверь список. Сохраняй, только если всё верно.",
        "custom_vocab_save": "Сохранить {count} слов",
        "custom_vocab_cancel": "Отменить",
        "custom_vocab_stale": "Время импорта истекло. Снова нажми «Добавить мои слова».",
        "custom_vocab_media_invalid": "Не удалось прочитать материал. Пришли чёткое JPG/PNG, PDF до 8 МБ или более короткий список.",
        "custom_vocab_ai_needed": "Добавь переводы в список или включи AI, чтобы Lexi заполнил их.",
        "custom_vocab_voice_unavailable": "Голосовой импорт недоступен или запись выходит за лимиты.",
        "custom_vocab_invalid_text": "Я не нашёл слов. Пиши по одному слову или фразе в строке; перевод можно не добавлять.",
        "custom_vocab_failed": "Не удалось подготовить слова. Ничего не сохранено; за неудачный AI-запрос кредит не списан.",
        "custom_vocab_cancelled": "Импорт отменён",
        "custom_vocab_language_changed": "Активный язык изменился. Начни импорт заново, чтобы слова не попали не в тот словарь.",
        "custom_vocab_saved_short": "Сохранено",
        "custom_vocab_saved": "✅ Твой словарь готов. Добавлено: {inserted}; обновлено: {updated}; всего для этой пары: {total}.",
        "custom_vocab_practice": "Учить мои слова",
        "custom_vocab_card_front": "Мои слова · {position}/{total}\n\n{target}{transcription}",
        "custom_vocab_reveal": "Показать перевод",
        "custom_vocab_stop": "Закончить",
        "custom_vocab_none": "Для активного языка пока нет твоих слов.",
        "custom_vocab_add": "Добавить мои слова",
        "custom_vocab_card_back": "Мои слова · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_dont_know": "Пока не знаю",
        "custom_vocab_know": "Знаю",
        "custom_vocab_practice_done": "🎉 Готово! Занятие по твоим словам завершено.",
    },
}
_CUSTOM_VOCABULARY_FALLBACK_LOCALES = {
    "fr": {
        "custom_vocab_prompt": "🦊 Ajoutons des mots en {language}.\n\nEnvoyez une liste (mot — traduction), une photo, un PDF ou un message vocal. Une liste complète est gratuite. La traduction automatique, les photos et PDF coûtent 1 crédit IA ; la voix peut en coûter 2. Je montrerai un aperçu avant l’enregistrement.",
        "custom_vocab_preview_title": "✨ J’ai préparé {count} mots", "custom_vocab_preview_more": "…et {count} autres", "custom_vocab_preview_confirm": "Vérifiez la liste avant de l’enregistrer.",
        "custom_vocab_stale": "Cet import a expiré. Ouvrez de nouveau « Ajouter mes mots ».", "custom_vocab_media_invalid": "Impossible de lire ce contenu. Envoyez une photo JPG/PNG nette, un PDF de 8 Mo maximum ou une liste plus courte.", "custom_vocab_ai_needed": "Ajoutez les traductions ou activez l’IA pour les compléter.", "custom_vocab_voice_unavailable": "L’import vocal est indisponible ou le message dépasse les limites.", "custom_vocab_invalid_text": "Aucun mot trouvé. Écrivez un mot ou une expression par ligne ; la traduction est facultative.", "custom_vocab_failed": "Impossible de préparer les mots. Rien n’a été enregistré et aucune requête IA échouée n’est facturée.",
        "custom_vocab_cancelled": "Import annulé", "custom_vocab_language_changed": "La langue active a changé. Recommencez pour éviter le mauvais dictionnaire.", "custom_vocab_saved_short": "Enregistré", "custom_vocab_saved": "✅ Votre dictionnaire est prêt. Ajoutés : {inserted} ; mis à jour : {updated} ; total pour cette paire : {total}.",
        "custom_vocab_card_front": "Mes mots · {position}/{total}\n\n{target}{transcription}", "custom_vocab_none": "Aucun mot personnel pour la langue active.", "custom_vocab_card_back": "Mes mots · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_save": "Enregistrer {count} mots", "custom_vocab_cancel": "Annuler", "custom_vocab_practice": "Étudier mes mots", "custom_vocab_add": "Ajouter mes mots", "custom_vocab_reveal": "Afficher la traduction", "custom_vocab_stop": "Arrêter", "custom_vocab_dont_know": "Je ne sais pas encore", "custom_vocab_know": "Je sais", "custom_vocab_practice_done": "🎉 Terminé ! La session est finie.",
    },
    "de": {
        "custom_vocab_prompt": "🦊 Füge Wörter für {language} hinzu.\n\nSende eine Liste (Wort — Übersetzung), ein Foto, PDF oder eine Sprachnachricht. Eine vollständige Liste ist kostenlos. Automatische Ergänzung, Foto und PDF kosten 1 KI-Credit; Sprache kann 2 kosten. Vor dem Speichern zeige ich eine Vorschau.",
        "custom_vocab_preview_title": "✨ Ich habe {count} Wörter vorbereitet", "custom_vocab_preview_more": "…und {count} weitere", "custom_vocab_preview_confirm": "Prüfe die Liste vor dem Speichern.",
        "custom_vocab_stale": "Dieser Import ist abgelaufen. Öffne „Eigene Wörter“ erneut.", "custom_vocab_media_invalid": "Der Inhalt konnte nicht gelesen werden. Sende ein klares JPG/PNG, ein PDF bis 8 MB oder eine kürzere Liste.", "custom_vocab_ai_needed": "Füge Übersetzungen hinzu oder aktiviere KI zum Ergänzen.", "custom_vocab_voice_unavailable": "Sprachimport ist nicht verfügbar oder die Nachricht überschreitet die Grenzen.", "custom_vocab_invalid_text": "Keine Wörter gefunden. Schreibe ein Wort oder einen Ausdruck pro Zeile; die Übersetzung ist optional.", "custom_vocab_failed": "Die Wörter konnten nicht vorbereitet werden. Nichts wurde gespeichert; fehlgeschlagene KI-Anfragen werden nicht berechnet.",
        "custom_vocab_cancelled": "Import abgebrochen", "custom_vocab_language_changed": "Die aktive Sprache hat sich geändert. Starte erneut, damit die Wörter im richtigen Wörterbuch landen.", "custom_vocab_saved_short": "Gespeichert", "custom_vocab_saved": "✅ Dein Wörterbuch ist bereit. Neu: {inserted}; aktualisiert: {updated}; insgesamt für dieses Paar: {total}.",
        "custom_vocab_card_front": "Eigene Wörter · {position}/{total}\n\n{target}{transcription}", "custom_vocab_none": "Für die aktive Sprache gibt es noch keine eigenen Wörter.", "custom_vocab_card_back": "Eigene Wörter · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_save": "{count} Wörter speichern", "custom_vocab_cancel": "Abbrechen", "custom_vocab_practice": "Eigene Wörter üben", "custom_vocab_add": "Eigene Wörter", "custom_vocab_reveal": "Übersetzung zeigen", "custom_vocab_stop": "Beenden", "custom_vocab_dont_know": "Noch nicht", "custom_vocab_know": "Gewusst", "custom_vocab_practice_done": "🎉 Fertig! Die Einheit ist abgeschlossen.",
    },
    "es": {
        "custom_vocab_prompt": "🦊 Añade palabras de {language}.\n\nEnvía una lista (palabra — traducción), una foto, un PDF o una nota de voz. Una lista completa es gratis. La traducción automática, fotos y PDF cuestan 1 crédito de IA; la voz puede costar 2. Verás una vista previa antes de guardar.",
        "custom_vocab_preview_title": "✨ He preparado {count} palabras", "custom_vocab_preview_more": "…y {count} más", "custom_vocab_preview_confirm": "Revisa la lista antes de guardarla.",
        "custom_vocab_stale": "Esta importación ha caducado. Abre de nuevo «Añadir mis palabras».", "custom_vocab_media_invalid": "No pude leer el contenido. Envía una foto JPG/PNG nítida, un PDF de hasta 8 MB o una lista más corta.", "custom_vocab_ai_needed": "Añade las traducciones o activa la IA para completarlas.", "custom_vocab_voice_unavailable": "La importación por voz no está disponible o la nota supera los límites.", "custom_vocab_invalid_text": "No encontré palabras. Escribe una palabra o frase por línea; la traducción es opcional.", "custom_vocab_failed": "No pude preparar las palabras. No se guardó nada y las solicitudes de IA fallidas no se cobran.",
        "custom_vocab_cancelled": "Importación cancelada", "custom_vocab_language_changed": "El idioma activo cambió. Empieza de nuevo para usar el diccionario correcto.", "custom_vocab_saved_short": "Guardado", "custom_vocab_saved": "✅ Tu diccionario está listo. Añadidas: {inserted}; actualizadas: {updated}; total para este par: {total}.",
        "custom_vocab_card_front": "Mis palabras · {position}/{total}\n\n{target}{transcription}", "custom_vocab_none": "Aún no tienes palabras propias para el idioma activo.", "custom_vocab_card_back": "Mis palabras · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_save": "Guardar {count} palabras", "custom_vocab_cancel": "Cancelar", "custom_vocab_practice": "Practicar mis palabras", "custom_vocab_add": "Añadir mis palabras", "custom_vocab_reveal": "Ver traducción", "custom_vocab_stop": "Terminar", "custom_vocab_dont_know": "Aún no", "custom_vocab_know": "Lo sé", "custom_vocab_practice_done": "🎉 ¡Listo! Sesión terminada.",
    },
    "ja": {
        "custom_vocab_prompt": "🦊 {language}の単語を追加します。\n\n単語—訳のリスト、写真、PDF、音声を送ってください。訳付きリストは無料です。自動補完・写真・PDFはAIクレジット1、音声は最大2です。保存前に確認できます。",
        "custom_vocab_preview_title": "✨ {count}語を準備しました", "custom_vocab_preview_more": "…ほか{count}語", "custom_vocab_preview_confirm": "保存する前に一覧を確認してください。",
        "custom_vocab_stale": "この読み込みは期限切れです。もう一度「単語を追加」を開いてください。", "custom_vocab_media_invalid": "内容を読み取れませんでした。鮮明なJPG/PNG、8MB以下のPDF、または短いリストを送ってください。", "custom_vocab_ai_needed": "訳を追加するか、AIを有効にして補完してください。", "custom_vocab_voice_unavailable": "音声読み込みを利用できないか、メッセージが制限を超えています。", "custom_vocab_invalid_text": "単語が見つかりません。1行に1語または1フレーズを書いてください。訳は任意です。", "custom_vocab_failed": "単語を準備できませんでした。保存されず、失敗したAIリクエストには課金されません。",
        "custom_vocab_cancelled": "読み込みをキャンセルしました", "custom_vocab_language_changed": "学習言語が変わりました。正しい辞書に保存するため、最初からやり直してください。", "custom_vocab_saved_short": "保存しました", "custom_vocab_saved": "✅ 辞書の準備ができました。追加：{inserted}、更新：{updated}、この組み合わせの合計：{total}。",
        "custom_vocab_card_front": "自分の単語 · {position}/{total}\n\n{target}{transcription}", "custom_vocab_none": "現在の言語には自分の単語がまだありません。", "custom_vocab_card_back": "自分の単語 · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_save": "{count}語を保存", "custom_vocab_cancel": "キャンセル", "custom_vocab_practice": "自分の単語を練習", "custom_vocab_add": "単語を追加", "custom_vocab_reveal": "訳を見る", "custom_vocab_stop": "終了", "custom_vocab_dont_know": "まだ分からない", "custom_vocab_know": "分かる", "custom_vocab_practice_done": "🎉 完了しました！",
    },
    "zh": {
        "custom_vocab_prompt": "🦊 添加{language}单词。\n\n发送“单词—翻译”列表、照片、PDF 或语音。完整列表免费；自动补全、照片和 PDF 消耗 1 个 AI 点数，语音最多 2 个。保存前会先预览。",
        "custom_vocab_preview_title": "✨ 已整理 {count} 个单词", "custom_vocab_preview_more": "…另有 {count} 个", "custom_vocab_preview_confirm": "保存前请检查列表。",
        "custom_vocab_stale": "本次导入已过期。请重新打开“添加我的单词”。", "custom_vocab_media_invalid": "无法读取内容。请发送清晰的 JPG/PNG、8MB 以内的 PDF 或更短的列表。", "custom_vocab_ai_needed": "请添加翻译，或启用 AI 自动补全。", "custom_vocab_voice_unavailable": "语音导入不可用，或语音超出限制。", "custom_vocab_invalid_text": "没有找到单词。请每行填写一个单词或短语；翻译可选。", "custom_vocab_failed": "无法整理单词。未保存任何内容，失败的 AI 请求不会扣点。",
        "custom_vocab_cancelled": "已取消导入", "custom_vocab_language_changed": "当前语言已更改。请重新导入，以免保存到错误的词典。", "custom_vocab_saved_short": "已保存", "custom_vocab_saved": "✅ 你的词典已准备好。新增：{inserted}；更新：{updated}；该语言组合共：{total}。",
        "custom_vocab_card_front": "我的单词 · {position}/{total}\n\n{target}{transcription}", "custom_vocab_none": "当前语言还没有自定义单词。", "custom_vocab_card_back": "我的单词 · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_save": "保存 {count} 个单词", "custom_vocab_cancel": "取消", "custom_vocab_practice": "练习我的单词", "custom_vocab_add": "添加我的单词", "custom_vocab_reveal": "显示翻译", "custom_vocab_stop": "结束", "custom_vocab_dont_know": "还不会", "custom_vocab_know": "会了", "custom_vocab_practice_done": "🎉 完成！本次练习已结束。",
    },
    "ar": {
        "custom_vocab_prompt": "🦊 أضف كلمات {language}.\n\nأرسل قائمة (كلمة — ترجمة) أو صورة أو PDF أو رسالة صوتية. القائمة الكاملة مجانية. الإكمال التلقائي والصورة وPDF تكلف رصيد AI واحداً؛ الصوت قد يكلف رصيدين. سأعرض معاينة قبل الحفظ.",
        "custom_vocab_preview_title": "✨ جهزت {count} كلمة", "custom_vocab_preview_more": "…و{count} أخرى", "custom_vocab_preview_confirm": "راجع القائمة قبل الحفظ.",
        "custom_vocab_stale": "انتهت صلاحية هذا الاستيراد. افتح «إضافة كلماتي» من جديد.", "custom_vocab_media_invalid": "تعذر قراءة المحتوى. أرسل صورة JPG/PNG واضحة أو PDF حتى 8 ميغابايت أو قائمة أقصر.", "custom_vocab_ai_needed": "أضف الترجمات أو فعّل AI لإكمالها.", "custom_vocab_voice_unavailable": "الاستيراد الصوتي غير متاح أو الرسالة تتجاوز الحدود.", "custom_vocab_invalid_text": "لم أجد كلمات. اكتب كلمة أو عبارة في كل سطر؛ الترجمة اختيارية.", "custom_vocab_failed": "تعذر تجهيز الكلمات. لم يُحفظ شيء ولا تُخصم تكلفة طلب AI الفاشل.",
        "custom_vocab_cancelled": "أُلغي الاستيراد", "custom_vocab_language_changed": "تغيرت اللغة النشطة. ابدأ من جديد للحفظ في القاموس الصحيح.", "custom_vocab_saved_short": "تم الحفظ", "custom_vocab_saved": "✅ قاموسك جاهز. أضيفت: {inserted}؛ حُدّثت: {updated}؛ المجموع لهذا الزوج: {total}.",
        "custom_vocab_card_front": "كلماتي · {position}/{total}\n\n{target}{transcription}", "custom_vocab_none": "لا توجد كلمات خاصة للغة النشطة بعد.", "custom_vocab_card_back": "كلماتي · {position}/{total}\n\n{target}{transcription}\n\n{meaning}",
        "custom_vocab_save": "حفظ {count} كلمة", "custom_vocab_cancel": "إلغاء", "custom_vocab_practice": "تدريب كلماتي", "custom_vocab_add": "إضافة كلماتي", "custom_vocab_reveal": "عرض الترجمة", "custom_vocab_stop": "إنهاء", "custom_vocab_dont_know": "لا أعرف بعد", "custom_vocab_know": "أعرف", "custom_vocab_practice_done": "🎉 تم! انتهى التدريب.",
    },
}
for _locale, _localized in _CUSTOM_VOCABULARY_FALLBACK_LOCALES.items():
    _CUSTOM_VOCABULARY_COPY[_locale] = {**_CUSTOM_VOCABULARY_COPY["en"], **_localized}
