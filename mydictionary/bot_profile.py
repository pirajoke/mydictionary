...
BOT_PROFILE_DEFAULTS = {
    ...
    "bot_description": (
        "MY DICTIONARY помогает учить английские, вьетнамские и японские "
        "слова тематическими блоками. В каждой карточке есть русский перевод, "
        "оригинальное написание, латинская транскрипция и произношение."
    ),
    "bot_start_text": (
        "Привет, {name}!\n\n"
        "MY DICTIONARY — тренажёр слов для регулярного обучения в Telegram.\n\n"
        "Выбирай английский, вьетнамский или японский язык, затем тему и блок "
        "из 10 связанных слов. После изучения можно пройти тест, ввод или "
        "карточки только по этому блоку.\n\n"
