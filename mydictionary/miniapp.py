...
_HELP_PRIVACY_COPY = {
    "en": {
        "detail_back": "Back", "help_title": "How Lexi works",
        "help_intro": "Build a useful vocabulary in a few short steps.",
        "help_step_choose_language": "Choose the language you want to learn.",
        "help_step_start_lesson": "Start a short lesson from your Profile.",
        "help_step_reveal_rate": "Reveal each meaning, then rate how well you knew it.",
        "help_step_review": "Review words when Lexi marks them as due.",
        "help_step_personal_words": "Add your own vocabulary in My words.",
        "help_profile_cta": "Go to Profile", "help_dictionary_cta": "Open My words",
        "privacy_title": "Privacy and your data",
        "privacy_learning_data": "Learning data includes your profile, lessons, progress, and personal vocabulary.",
        "privacy_voice_transcripts": "Voice transcripts are stored only for the configured retention period.",
        "privacy_ai_memory": "AI consent controls optional tutor processing; Mirror memory keeps bounded recent dialogue only when enabled.",
        "privacy_billing_audit": "Required billing and audit records remain for refunds, reconciliation, and fraud prevention.",
        "privacy_erasure_effect": "Erasing learning data cannot be undone and blocks further access to the learner account.",
        "privacy_ai_consent": "AI processing consent", "privacy_voice_consent": "Voice processing consent",
        "privacy_mirror_memory": "Mirror memory", "privacy_retention": "Mirror dialogue: {mirror_days} days · voice transcripts: {voice_days} days",
        "privacy_status_granted": "Granted", "privacy_status_not_granted": "Not granted",
        "privacy_status_disabled": "Disabled", "privacy_status_unavailable": "Unavailable",
        "privacy_revoke_ai": "Revoke AI consent", "privacy_revoke_voice": "Revoke voice consent",
        "privacy_erase_learning": "Erase learning data", "privacy_confirm_erase": "Erase your learning data permanently?",
        "privacy_action_pending": "Saving your choice…", "privacy_action_success": "Your privacy choice was saved.",
        "privacy_action_error": "Your choice could not be saved.", "privacy_action_retry": "Please try again.",
        "help_command_intro": "Lexi help is ready in the app.", "privacy_command_intro": "Review your privacy choices in the app.",
        "help_open": "Open help", "privacy_open": "Open privacy",
    },
    "fr": {
        "detail_back": "Retour", "help_title": "Comment fonctionne Lexi",
        "help_intro": "Construisez un vocabulaire utile en quelques étapes courtes.",
        "help_step_choose_language": "Choisissez la langue que vous souhaitez apprendre.",
        "help_step_start_lesson": "Commencez une courte leçon depuis votre Profil.",
        "help_step_reveal_rate": "Affichez chaque sens, puis indiquez si vous le connaissiez.",
        "help_step_review": "Révisez les mots lorsque Lexi les signale comme à revoir.",
        "help_step_personal_words": "Ajoutez votre propre vocabulaire dans Mes mots.",
        "help_profile_cta": "Aller au Profil", "help_dictionary_cta": "Ouvrir Mes mots",
        "privacy_title": "Confidentialité et données",
        "privacy_learning_data": "Les données d’apprentissage comprennent votre profil, vos leçons, votre progression et votre vocabulaire personnel.",
        "privacy_voice_transcripts": "Les transcriptions vocales ne sont conservées que pendant la durée configurée.",
        "privacy_ai_memory": "Le consentement IA contrôle le tuteur facultatif ; la mémoire Mirror ne garde qu’un dialogue récent limité lorsqu’elle est active.",
        "privacy_billing_audit": "Les registres obligatoires de paiement et d’audit restent conservés pour les remboursements, les contrôles et la prévention de la fraude.",
        "privacy_erasure_effect": "L’effacement des données d’apprentissage est irréversible et bloque ensuite l’accès au compte apprenant.",
        "privacy_ai_consent": "Consentement au traitement IA", "privacy_voice_consent": "Consentement au traitement vocal",
        "privacy_mirror_memory": "Mémoire Mirror", "privacy_retention": "Dialogue Mirror : {mirror_days} jours · transcriptions vocales : {voice_days} jours",
        "privacy_status_granted": "Accordé", "privacy_status_not_granted": "Non accordé",
        "privacy_status_disabled": "Désactivé", "privacy_status_unavailable": "Indisponible",
        "privacy_revoke_ai": "Retirer le consentement IA", "privacy_revoke_voice": "Retirer le consentement vocal",
        "privacy_erase_learning": "Effacer les données d’apprentissage", "privacy_confirm_erase": "Effacer définitivement vos données d’apprentissage ?",
        "privacy_action_pending": "Enregistrement de votre choix…", "privacy_action_success": "Votre choix de confidentialité a été enregistré.",
        "privacy_action_error": "Votre choix n’a pas pu être enregistré.", "privacy_action_retry": "Veuillez réessayer.",
        "help_command_intro": "L’aide Lexi est disponible dans l’app.", "privacy_command_intro": "Consultez vos choix de confidentialité dans l’app.",
        "help_open": "Ouvrir l’aide", "privacy_open": "Ouvrir la confidentialité",
    },
    "de": {
        "detail_back": "Zurück", "help_title": "So funktioniert Lexi",
        "help_intro": "Baue in wenigen kurzen Schritten einen nützlichen Wortschatz auf.",
        "help_step_choose_language": "Wähle die Sprache, die du lernen möchtest.",
        "help_step_start_lesson": "Starte im Profil eine kurze Lektion.",
        "help_step_reveal_rate": "Zeige jede Bedeutung und bewerte dann, wie gut du sie kanntest.",
        "help_step_review": "Wiederhole Wörter, sobald Lexi sie als fällig markiert.",
        "help_step_personal_words": "Füge unter Meine Wörter eigenen Wortschatz hinzu.",
        "help_profile_cta": "Zum Profil", "help_dictionary_cta": "Meine Wörter öffnen",
        "privacy_title": "Datenschutz und deine Daten",
        "privacy_learning_data": "Lerndaten umfassen dein Profil, Lektionen, Fortschritt und eigene Wörter.",
        "privacy_voice_transcripts": "Sprachtranskripte werden nur für die konfigurierte Frist gespeichert.",
        "privacy_ai_memory": "Die KI-Einwilligung steuert den optionalen Tutor; Mirror speichert nur bei Aktivierung einen begrenzten jüngsten Dialog.",
        "privacy_billing_audit": "Erforderliche Zahlungs- und Prüfdatensätze bleiben für Erstattungen, Abgleich und Betrugsschutz erhalten.",
        "privacy_erasure_effect": "Das Löschen der Lerndaten ist endgültig und sperrt den weiteren Zugang zum Lernkonto.",
        "privacy_ai_consent": "Einwilligung zur KI-Verarbeitung", "privacy_voice_consent": "Einwilligung zur Sprachverarbeitung",
        "privacy_mirror_memory": "Mirror-Speicher", "privacy_retention": "Mirror-Dialog: {mirror_days} Tage · Sprachtranskripte: {voice_days} Tage",
        "privacy_status_granted": "Erteilt", "privacy_status_not_granted": "Nicht erteilt",
        "privacy_status_disabled": "Deaktiviert", "privacy_status_unavailable": "Nicht verfügbar",
        "privacy_revoke_ai": "KI-Einwilligung widerrufen", "privacy_revoke_voice": "Spracheinwilligung widerrufen",
        "privacy_erase_learning": "Lerndaten löschen", "privacy_confirm_erase": "Deine Lerndaten endgültig löschen?",
        "privacy_action_pending": "Deine Auswahl wird gespeichert…", "privacy_action_success": "Deine Datenschutzauswahl wurde gespeichert.",
        "privacy_action_error": "Deine Auswahl konnte nicht gespeichert werden.", "privacy_action_retry": "Bitte versuche es erneut.",
        "help_command_intro": "Die Lexi-Hilfe ist in der App verfügbar.", "privacy_command_intro": "Prüfe deine Datenschutzauswahl in der App.",
        "help_open": "Hilfe öffnen", "privacy_open": "Datenschutz öffnen",
    },
    "ja": {
        "detail_back": "戻る", "help_title": "Lexi の使い方",
        "help_intro": "短いステップで、役立つ語彙を身につけましょう。",
        "help_step_choose_language": "学びたい言語を選びます。",
        "help_step_start_lesson": "プロフィールから短いレッスンを始めます。",
        "help_step_reveal_rate": "単語の意味を表示し、覚えていた度合いを評価します。",
        "help_step_review": "Lexi が復習時期を示した単語を見直します。",
        "help_step_personal_words": "「単語」に自分の語彙を追加します。",
        "help_profile_cta": "プロフィールへ", "help_dictionary_cta": "単語を開く",
        "privacy_title": "プライバシーとデータ",
        "privacy_learning_data": "学習データには、プロフィール、レッスン、進捗、個人の単語が含まれます。",
        "privacy_voice_transcripts": "音声の文字起こしは、設定された保存期間だけ保管されます。",
        "privacy_ai_memory": "AI 同意は任意のチューター処理を管理し、Mirror メモリは有効時のみ最近の会話を限定保存します。",
        "privacy_billing_audit": "返金、照合、不正防止に必要な支払い・監査記録は保持されます。",
        "privacy_erasure_effect": "学習データの消去は取り消せず、その後は学習者アカウントを利用できません。",
        "privacy_ai_consent": "AI 処理への同意", "privacy_voice_consent": "音声処理への同意",
        "privacy_mirror_memory": "Mirror メモリ", "privacy_retention": "Mirror 会話：{mirror_days}日 · 音声文字起こし：{voice_days}日",
        "privacy_status_granted": "同意済み", "privacy_status_not_granted": "未同意",
        "privacy_status_disabled": "無効", "privacy_status_unavailable": "利用不可",
        "privacy_revoke_ai": "AI 同意を取り消す", "privacy_revoke_voice": "音声同意を取り消す",
        "privacy_erase_learning": "学習データを消去", "privacy_confirm_erase": "学習データを完全に消去しますか？",
        "privacy_action_pending": "選択を保存しています…", "privacy_action_success": "プライバシー設定を保存しました。",
        "privacy_action_error": "選択を保存できませんでした。", "privacy_action_retry": "もう一度お試しください。",
        "help_command_intro": "Lexi のヘルプをアプリで確認できます。", "privacy_command_intro": "プライバシー設定をアプリで確認できます。",
        "help_open": "ヘルプを開く", "privacy_open": "プライバシーを開く",
    },
    "ar": {
        "detail_back": "رجوع", "help_title": "كيف يعمل Lexi",
        "help_intro": "ابنِ مفردات مفيدة بخطوات قصيرة.",
        "help_step_choose_language": "اختر اللغة التي تريد تعلمها.",
        "help_step_start_lesson": "ابدأ درساً قصيراً من ملفك الشخصي.",
        "help_step_reveal_rate": "اكشف معنى كل كلمة ثم قيّم مدى معرفتك بها.",
        "help_step_review": "راجع الكلمات عندما يحدد Lexi موعدها.",
        "help_step_personal_words": "أضف مفرداتك الخاصة في كلماتي.",
        "help_profile_cta": "الذهاب إلى الملف الشخصي", "help_dictionary_cta": "فتح كلماتي",
        "privacy_title": "الخصوصية وبياناتك",
        "privacy_learning_data": "تشمل بيانات التعلم ملفك ودروسك وتقدمك ومفرداتك الخاصة.",
        "privacy_voice_transcripts": "تُحفظ نصوص الصوت فقط خلال مدة الاحتفاظ المضبوطة.",
        "privacy_ai_memory": "تتحكم موافقة AI في المعلم الاختياري، ولا تحفظ ذاكرة Mirror إلا حواراً حديثاً محدوداً عند تفعيلها.",
        "privacy_billing_audit": "تبقى سجلات الدفع والتدقيق اللازمة للاسترداد والمطابقة ومنع الاحتيال.",
        "privacy_erasure_effect": "لا يمكن التراجع عن مسح بيانات التعلم، وسيُحظر بعدها دخول حساب المتعلم.",
        "privacy_ai_consent": "موافقة معالجة AI", "privacy_voice_consent": "موافقة معالجة الصوت",
        "privacy_mirror_memory": "ذاكرة Mirror", "privacy_retention": "حوار Mirror: {mirror_days} أيام · نصوص الصوت: {voice_days} أيام",
        "privacy_status_granted": "ممنوحة", "privacy_status_not_granted": "غير ممنوحة",
        "privacy_status_disabled": "معطّلة", "privacy_status_unavailable": "غير متاحة",
        "privacy_revoke_ai": "سحب موافقة AI", "privacy_revoke_voice": "سحب موافقة الصوت",
        "privacy_erase_learning": "مسح بيانات التعلم", "privacy_confirm_erase": "هل تريد مسح بيانات تعلمك نهائياً؟",
        "privacy_action_pending": "جارٍ حفظ اختيارك…", "privacy_action_success": "تم حفظ اختيار الخصوصية.",
        "privacy_action_error": "تعذر حفظ اختيارك.", "privacy_action_retry": "يرجى المحاولة مجدداً.",
        "help_command_intro": "مساعدة Lexi جاهزة داخل التطبيق.", "privacy_command_intro": "راجع خيارات الخصوصية داخل التطبيق.",
        "help_open": "فتح المساعدة", "privacy_open": "فتح الخصوصية",
    },
    "zh": {
        "detail_back": "返回", "help_title": "Lexi 使用方法",
        "help_intro": "通过几个简短步骤建立实用词汇。",
        "help_step_choose_language": "选择你想学习的语言。",
        "help_step_start_lesson": "从个人资料开始一节短课。",
        "help_step_reveal_rate": "查看每个词义，然后评价掌握程度。",
        "help_step_review": "在 Lexi 标记到期时复习单词。",
        "help_step_personal_words": "在“我的单词”中添加个人词汇。",
        "help_profile_cta": "前往个人资料", "help_dictionary_cta": "打开我的单词",
        "privacy_title": "隐私与数据",
        "privacy_learning_data": "学习数据包括个人资料、课程、进度和个人词汇。",
        "privacy_voice_transcripts": "语音转写只在配置的保留期限内保存。",
        "privacy_ai_memory": "AI 同意控制可选导师处理；Mirror 记忆仅在启用时有限保存近期对话。",
        "privacy_billing_audit": "退款、对账和防欺诈所需的付款及审计记录会继续保留。",
        "privacy_erasure_effect": "学习数据删除后无法恢复，学习者账户也将停止访问。",
        "privacy_ai_consent": "AI 处理同意", "privacy_voice_consent": "语音处理同意",
        "privacy_mirror_memory": "Mirror 记忆", "privacy_retention": "Mirror 对话：{mirror_days}天 · 语音转写：{voice_days}天",
        "privacy_status_granted": "已授权", "privacy_status_not_granted": "未授权",
        "privacy_status_disabled": "已关闭", "privacy_status_unavailable": "不可用",
        "privacy_revoke_ai": "撤回 AI 同意", "privacy_revoke_voice": "撤回语音同意",
        "privacy_erase_learning": "删除学习数据", "privacy_confirm_erase": "永久删除你的学习数据吗？",
        "privacy_action_pending": "正在保存你的选择…", "privacy_action_success": "隐私选择已保存。",
        "privacy_action_error": "无法保存你的选择。", "privacy_action_retry": "请重试。",
        "help_command_intro": "可在应用中查看 Lexi 帮助。", "privacy_command_intro": "可在应用中查看隐私选项。",
        "help_open": "打开帮助", "privacy_open": "打开隐私设置",
    },
    "ru": {
        "detail_back": "Назад", "help_title": "Как работает Lexi",
        "help_intro": "Соберите полезный словарь за несколько коротких шагов.",
        "help_step_choose_language": "Выберите язык, который хотите изучать.",
        "help_step_start_lesson": "Начните короткий урок из Профиля.",
        "help_step_reveal_rate": "Откройте значение слова и оцените, насколько хорошо вы его знали.",
        "help_step_review": "Повторяйте слова, когда Lexi отмечает их как готовые к повторению.",
        "help_step_personal_words": "Добавляйте собственную лексику в Мои слова.",
        "help_profile_cta": "Перейти в Профиль", "help_dictionary_cta": "Открыть Мои слова",
        "privacy_title": "Приватность и ваши данные",
        "privacy_learning_data": "Учебные данные включают профиль, уроки, прогресс и личный словарь.",
        "privacy_voice_transcripts": "Расшифровки голоса хранятся только в течение заданного срока.",
        "privacy_ai_memory": "AI-согласие управляет необязательным репетитором; память Mirror хранит ограниченный недавний диалог только при включении.",
        "privacy_billing_audit": "Обязательные платёжные и аудиторские записи сохраняются для возвратов, сверки и защиты от мошенничества.",
        "privacy_erasure_effect": "Стирание учебных данных необратимо и блокирует дальнейший доступ к аккаунту ученика.",
        "privacy_ai_consent": "Согласие на обработку AI", "privacy_voice_consent": "Согласие на обработку голоса",
        "privacy_mirror_memory": "Память Mirror", "privacy_retention": "Диалог Mirror: {mirror_days} дней · расшифровки голоса: {voice_days} дней",
        "privacy_status_granted": "Выдано", "privacy_status_not_granted": "Не выдано",
        "privacy_status_disabled": "Выключено", "privacy_status_unavailable": "Недоступно",
        "privacy_revoke_ai": "Отозвать AI-согласие", "privacy_revoke_voice": "Отозвать согласие на голос",
        "privacy_erase_learning": "Стереть учебные данные", "privacy_confirm_erase": "Навсегда стереть ваши учебные данные?",
        "privacy_action_pending": "Сохраняем ваш выбор…", "privacy_action_success": "Настройки приватности сохранены.",
        "privacy_action_error": "Не удалось сохранить ваш выбор.", "privacy_action_retry": "Попробуйте ещё раз.",
        "help_command_intro": "Справка Lexi доступна в приложении.", "privacy_command_intro": "Проверьте настройки приватности в приложении.",
        "help_open": "Открыть справку", "privacy_open": "Открыть приватность",
    },
    "es": {
        "detail_back": "Volver", "help_title": "Cómo funciona Lexi",
        "help_intro": "Crea un vocabulario útil en unos pasos breves.",
        "help_step_choose_language": "Elige el idioma que quieres aprender.",
        "help_step_start_lesson": "Inicia una lección breve desde tu Perfil.",
        "help_step_reveal_rate": "Revela cada significado y valora cuánto lo conocías.",
        "help_step_review": "Repasa las palabras cuando Lexi indique que toca revisarlas.",
        "help_step_personal_words": "Añade tu propio vocabulario en Mis palabras.",
        "help_profile_cta": "Ir al Perfil", "help_dictionary_cta": "Abrir Mis palabras",
        "privacy_title": "Privacidad y tus datos",
        "privacy_learning_data": "Los datos de aprendizaje incluyen tu perfil, lecciones, progreso y vocabulario personal.",
        "privacy_voice_transcripts": "Las transcripciones de voz solo se guardan durante el plazo configurado.",
        "privacy_ai_memory": "El consentimiento de IA controla el tutor opcional; la memoria Mirror solo conserva diálogo reciente limitado cuando está activa.",
        "privacy_billing_audit": "Los registros obligatorios de pagos y auditoría se conservan para reembolsos, conciliación y prevención del fraude.",
        "privacy_erasure_effect": "Borrar los datos de aprendizaje es irreversible y bloquea el acceso posterior a la cuenta del alumno.",
        "privacy_ai_consent": "Consentimiento de procesamiento de IA", "privacy_voice_consent": "Consentimiento de procesamiento de voz",
        "privacy_mirror_memory": "Memoria Mirror", "privacy_retention": "Diálogo Mirror: {mirror_days} días · transcripciones de voz: {voice_days} días",
        "privacy_status_granted": "Concedido", "privacy_status_not_granted": "No concedido",
        "privacy_status_disabled": "Desactivado", "privacy_status_unavailable": "No disponible",
        "privacy_revoke_ai": "Revocar consentimiento de IA", "privacy_revoke_voice": "Revocar consentimiento de voz",
        "privacy_erase_learning": "Borrar datos de aprendizaje", "privacy_confirm_erase": "¿Borrar tus datos de aprendizaje para siempre?",
        "privacy_action_pending": "Guardando tu elección…", "privacy_action_success": "Se guardó tu elección de privacidad.",
        "privacy_action_error": "No se pudo guardar tu elección.", "privacy_action_retry": "Inténtalo de nuevo.",
        "help_command_intro": "La ayuda de Lexi está disponible en la app.", "privacy_command_intro": "Revisa tus opciones de privacidad en la app.",
        "help_open": "Abrir ayuda", "privacy_open": "Abrir privacidad",
    },
}
for _locale, _copy in _HELP_PRIVACY_COPY.items():
    MINIAPP_COPY[_locale].update(_copy)
...
def build_bootstrap(
    ...
    *,
    ...
    mirror_memory_enabled: bool = False,
    mirror_retention_days: int = 7,
    ...
    ai_consent = "disabled" if not ai_enabled else "unavailable"
    voice_consent = "disabled" if not voice_enabled else "unavailable"
    if ai_enabled and str(ai_consent_version or "").strip():
        ai_consent = (
            "granted"
            if store.has_consent(
                int(user_id),
                consent_type="ai_processing",
                document_version=str(ai_consent_version),
            )
            else "not_granted"
        )
    if voice_enabled and str(voice_consent_version or "").strip():
        voice_consent = (
            "granted"
            if store.has_consent(
                int(user_id),
                consent_type="voice_processing",
                document_version=str(voice_consent_version),
            )
            else "not_granted"
        )
    privacy = {
        ...
        "mirror_memory": "enabled" if mirror_memory_enabled else "disabled",
        "retention_days": {
            "mirror_dialogue": max(1, min(30, int(mirror_retention_days))),
            "voice_transcripts": max(
                1, min(365, int(voice_transcript_retention_days))
            ),
        },
    }
