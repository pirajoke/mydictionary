...
MINIAPP_COPY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "continue_lesson": "Continue lesson", "ai_tutor": "AI Tutor", "share": "Share",
    ...
    "fr": {
        ...
        "continue_lesson": "Continuer la leçon", "ai_tutor": "Tuteur IA", "share": "Partager",
    ...
    "de": {
        ...
        "continue_lesson": "Lektion fortsetzen", "ai_tutor": "KI-Tutor", "share": "Teilen",
    ...
    "ja": {
        ...
        "continue_lesson": "レッスンを続ける", "ai_tutor": "AIチューター", "share": "共有",
    ...
    "ar": {
        ...
        "continue_lesson": "متابعة الدرس", "ai_tutor": "مدرّس AI", "share": "مشاركة",
    ...
    "zh": {
        ...
        "continue_lesson": "继续课程", "ai_tutor": "AI 导师", "share": "分享",
    ...
    "ru": {
        ...
        "continue_lesson": "Продолжить урок", "ai_tutor": "AI-репетитор", "share": "Поделиться",
    ...
    "es": {
        ...
        "continue_lesson": "Continuar la lección", "ai_tutor": "Tutor de IA", "share": "Compartir",
