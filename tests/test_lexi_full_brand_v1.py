...
class LexiFullBrandContractTest(unittest.TestCase):
    ...
    def test_active_ai_personas_use_lexi_and_preserve_previous_contracts(self) -> None:
        ...
        self.assertTrue((ROOT / "prompts/mirror-v9.txt").is_file())
